...
export const Slider = () => {
  ...
  if (pageSize.lg) return <Layout.Sider collapsed collapsedWidth={collapsedWidth} style={{position: "relative"}}>
    ...
    <Button className={"sliderSwitch leftSliderSwitch"} onClick={handlePrev}>&#8249;</Button>
    <Button className={"sliderSwitch rightSliderSwitch"} onClick={handleNext}>&#8250;</Button>
  </Layout.Sider>
  return <></>
}